    ...
    <>
      ...
      <Card className={s.card} id="about">
        ...
        <p className={s.p}>
          ...
          can an NFT really have, so long as the token itself is not inseprable
      ...
      <Card className={s.card} id="faq">
        ...
        <p>
          ...
          Ethereum blockahain. Each token is unique and can not be replace by
          ...
          art. Think about them as digital collectibles, whose uniquness and
        ...
        <p>
          ...
          with ETH. Once you do that, you can use the "connect" button a the top
        ...
        <p>
          ...
          your newly adoped punk will show up here. Since AsciiPunks are an
